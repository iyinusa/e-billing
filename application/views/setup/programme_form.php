<?php echo form_open('programme/form/'.$param1.'/'.$param2, array('id'=>'bb_ajax_form','class'=>'form-horizontal')); ?>
	<div id="bb_ajax_msg"></div><br />
    
    <?php if($param1 == 'del') { // delete view ?>
        <div class="col-xs-12 text-center">
            <h3><b>Are you sure?</b></h3>
            <input type="hidden" name="d_prog_id" value="<?php if(!empty($d_id)){echo $d_id;} ?>" />
        </div>
            ...
            <div class="form-group">
                <div class="col-xs-12 col-sm-8">
                    <div class="form-material">
                        <input id="prog_id" name="prog_id" type="hidden" value="<?php if(!empty($e_id)){echo $e_id;} ?>">
