<?php echo form_open('sessions/form/'.$param1.'/'.$param2, array('id'=>'bb_ajax_form','class'=>'form-horizontal')); ?>
            ...
            <div class="form-group">
                <div class="col-xs-12 col-sm-8">
                    <div class="form-material">
                        <input id="session_id" name="session_id" type="hidden" value="<?php if(!empty($e_id)){echo $e_id;} ?>">
